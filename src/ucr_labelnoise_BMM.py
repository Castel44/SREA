...
from src.utils.training_helper_BMM import main_wrapper, plot_label_insight
...
def parse_args():
    ...
    parser.add_argument('--ni', type=float, nargs='+', default=[0, 15, 30, 45, 60], help='label noise ratio')
